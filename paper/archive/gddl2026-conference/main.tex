...
generic fixed-stage Runge--Kutta discretization. Our result does not refute
Lipschitz-guided schedules: in the tested systems the averaged-regularity
\emph{ordering} does not determine the fixed-NFE $\wtwo$ ordering, because
the tested averaged-regularity scalar does not retain the temporal information
carried by solver-stage sampling and transported signed defects. All
